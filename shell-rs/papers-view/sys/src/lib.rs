...
pub type PpsJobRunMode = c_int;
pub const PPS_JOB_RUN_THREAD: PpsJobRunMode = 0;
pub const PPS_JOB_RUN_MAIN_LOOP: PpsJobRunMode = 1;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct PpsJobRenderCairoClass {
    pub parent_class: PpsJobClass,
}

impl ::std::fmt::Debug for PpsJobRenderCairoClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsJobRenderCairoClass @ {self:p}"))
            .field("parent_class", &self.parent_class)
            .finish()
    }
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct PpsJobThumbnailCairoClass {
    pub parent_class: PpsJobClass,
}

impl ::std::fmt::Debug for PpsJobThumbnailCairoClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsJobThumbnailCairoClass @ {self:p}"))
            .field("parent_class", &self.parent_class)
            .finish()
    }
}
...
pub type PpsPrintOperationClass = *mut _PpsPrintOperationClass;
...
pub type PpsViewClass = *mut _PpsViewClass;
...
pub type PpsViewPresentationClass = *mut _PpsViewPresentationClass;
...
#[repr(C)]
pub struct PpsJobRenderCairo {
    _truncated_record_marker: c_void,
    // /*Ignored*/field parent has incomplete type
}

impl ::std::fmt::Debug for PpsJobRenderCairo {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsJobRenderCairo @ {self:p}"))
            .finish()
    }
}
...
#[repr(C)]
pub struct PpsJobThumbnailCairo {
    _truncated_record_marker: c_void,
    // /*Ignored*/field parent has incomplete type
}

impl ::std::fmt::Debug for PpsJobThumbnailCairo {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsJobThumbnailCairo @ {self:p}"))
            .finish()
    }
}
...
extern "C" {
    ...
    // PpsJobRunMode
    //=========================================================================
    pub fn pps_job_run_mode_get_type() -> GType;
    ...
    pub fn pps_job_scheduler_get_running_thread_job() -> *mut PpsJob;
    ...
    pub fn pps_job_get_run_mode(job: *mut PpsJob) -> PpsJobRunMode;
    pub fn pps_job_is_failed(job: *mut PpsJob) -> gboolean;
    ...
    pub fn pps_job_set_run_mode(job: *mut PpsJob, run_mode: PpsJobRunMode);
    ...
    pub fn pps_job_find_get_progress(job: *mut PpsJobFind) -> c_double;
    ...
    pub fn pps_job_links_get_model(job: *mut PpsJobLinks) -> *mut gtk::GtkTreeModel;
    ...
    // PpsJobRenderCairo
    //=========================================================================
    pub fn pps_job_render_cairo_get_type() -> GType;
    pub fn pps_job_render_cairo_new(
        document: *mut papers_document::PpsDocument,
        page: c_int,
        rotation: c_int,
        scale: c_double,
    ...
    pub fn pps_job_render_cairo_set_selection_info(
        job: *mut PpsJobRenderCairo,
    ...
    //=========================================================================
    pub fn pps_job_thumbnail_cairo_get_type() -> GType;
    pub fn pps_job_thumbnail_cairo_new(
        document: *mut papers_document::PpsDocument,
        page: c_int,
        rotation: c_int,
        scale: c_double,
    ) -> *mut PpsJob;
    pub fn pps_job_thumbnail_cairo_new_with_target_size(
        document: *mut papers_document::PpsDocument,
        page: c_int,
        rotation: c_int,
        target_width: c_int,
    ...
    pub fn pps_view_autoscroll_start(view: *mut PpsView);
    pub fn pps_view_autoscroll_stop(view: *mut PpsView);
    ...
    pub fn pps_view_find_search_changed(view: *mut PpsView);
    ...
    pub fn pps_view_hide_cursor(view: *mut PpsView);
    pub fn pps_view_highlight_forward_search(
        view: *mut PpsView,
        link: *mut papers_document::PpsSourceLink,
    );
    ...
    pub fn pps_view_show_cursor(view: *mut PpsView);
