...
#[repr(C)]
pub struct _PpsBookmarksClass {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

pub type PpsBookmarksClass = _PpsBookmarksClass;
...
pub struct PpsJobLoad {
    ...
    pub password_save: gio::GPasswordSave,
    pub flags: papers_document::PpsDocumentLoadFlags,
    pub loaded_document: *mut papers_document::PpsDocument,
}
...
impl ::std::fmt::Debug for PpsJobLoad {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsJobLoad @ {self:p}"))
            ...
            .field("password_save", &self.password_save)
