...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ...
    (
        "PpsJobRenderCairoClass",
        Layout {
            size: size_of::<PpsJobRenderCairoClass>(),
            alignment: align_of::<PpsJobRenderCairoClass>(),
        },
    ),
    (
    ...
    (
        "PpsJobRunMode",
        Layout {
            size: size_of::<PpsJobRunMode>(),
            alignment: align_of::<PpsJobRunMode>(),
        },
    ),
    (
        "PpsJobSaveClass",
    ...
    (
        "PpsJobThumbnailCairoClass",
        Layout {
            size: size_of::<PpsJobThumbnailCairoClass>(),
            alignment: align_of::<PpsJobThumbnailCairoClass>(),
        },
    ),
    (
...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    ("(gint) PPS_JOB_RUN_MAIN_LOOP", "1"),
    ("(gint) PPS_JOB_RUN_THREAD", "0"),
