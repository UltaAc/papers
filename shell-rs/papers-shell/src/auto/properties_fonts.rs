...
glib::wrapper! {
    #[doc(alias = "PpsPropertiesFonts")]
    pub struct PropertiesFonts(Object<ffi::PpsPropertiesFonts, ffi::PpsPropertiesFontsClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;

    match fn {
        type_ => || ffi::pps_properties_fonts_get_type(),
    }
}
...
impl PropertiesFonts {
    ...
    pub fn new() -> PropertiesFonts {
        ...
        unsafe { gtk::Widget::from_glib_none(ffi::pps_properties_fonts_new()).unsafe_cast() }
    }

    // rustdoc-stripper-ignore-next
    /// Creates a new builder-pattern struct instance to construct [`PropertiesFonts`] objects.
    ///
...
impl Default for PropertiesFonts {
    fn default() -> Self {
        Self::new()
    }
}
...
// rustdoc-stripper-ignore-next
/// A [builder-pattern] type to construct [`PropertiesFonts`] objects.
///
/// [builder-pattern]: https://doc.rust-lang.org/1.0.0/style/ownership/builders.html
#[must_use = "The builder must be built to be used"]
pub struct PropertiesFontsBuilder {
    builder: glib::object::ObjectBuilder<'static, PropertiesFonts>,
}

impl PropertiesFontsBuilder {
    fn new() -> Self {
        Self {
    ...
    // rustdoc-stripper-ignore-next
    /// Build the [`PropertiesFonts`].
    #[must_use = "Building the object from the builder is usually expensive and is not expected to have side effects"]
    pub fn build(self) -> PropertiesFonts {
        self.builder.build()
    }
}
