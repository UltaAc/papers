...
extern "C" {
    ...
    pub fn pps_document_view_get_header_bar(
        pps_doc_view: *mut PpsDocumentView,
    ) -> *mut adw::AdwHeaderBar;
    pub fn pps_document_view_get_metadata(pps_doc_view: *mut PpsDocumentView) -> *mut PpsMetadata;
    ...
    pub fn pps_keyring_lookup_password(uri: *const c_char) -> *mut c_char;
    pub fn pps_keyring_save_password(
        uri: *const c_char,
        password: *const c_char,
        flags: gio::GPasswordSave,
    ) -> gboolean;
