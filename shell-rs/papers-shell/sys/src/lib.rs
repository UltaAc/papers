...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct PpsPropertiesFontsClass {
    pub parent_class: adw::AdwBinClass,
}

impl ::std::fmt::Debug for PpsPropertiesFontsClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsPropertiesFontsClass @ {self:p}"))
            .field("parent_class", &self.parent_class)
            .finish()
    }
}
