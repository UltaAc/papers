...
pub const PPS_WINDOW_MODE_PASSWORD_VIEW: PpsWindowRunMode = 4;
...
pub type PpsObjectManagerClientPrivate = *mut _PpsObjectManagerClientPrivate;
...
pub type PpsObjectProxyPrivate = *mut _PpsObjectProxyPrivate;
...
pub type PpsObjectSkeletonPrivate = *mut _PpsObjectSkeletonPrivate;
...
impl ::std::fmt::Debug for PpsPapersApplicationIface {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsPapersApplicationIface @ {self:p}"))
            ...
            .field("handle_reload", &self.handle_reload)
            .finish()
    }
}
...
pub type PpsPapersApplicationProxyPrivate = *mut _PpsPapersApplicationProxyPrivate;
...
pub type PpsPapersApplicationSkeletonPrivate = *mut _PpsPapersApplicationSkeletonPrivate;

#[derive(Copy, Clone)]
#[repr(C)]
pub struct PpsPapersWindowIface {
    pub parent_iface: gobject::GTypeInterface,
    pub handle_sync_view: Option<
        unsafe extern "C" fn(
            *mut PpsPapersWindow,
            *mut gio::GDBusMethodInvocation,
            *const c_char,
    ...
    pub sync_source: Option<
        unsafe extern "C" fn(*mut PpsPapersWindow, *const c_char, *mut glib::GVariant, c_uint),
    >,
}
...
impl ::std::fmt::Debug for PpsPapersWindowIface {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsPapersWindowIface @ {self:p}"))
            .field("parent_iface", &self.parent_iface)
            .field("handle_sync_view", &self.handle_sync_view)
...
pub type PpsPapersWindowProxyPrivate = *mut _PpsPapersWindowProxyPrivate;
...
pub type PpsPapersWindowSkeletonPrivate = *mut _PpsPapersWindowSkeletonPrivate;
...
#[repr(C)]
pub struct _PpsPropertiesFontsClass {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

pub type PpsPropertiesFontsClass = *mut _PpsPropertiesFontsClass;

#[repr(C)]
pub struct _PpsPropertiesFontsPrivate {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

pub type PpsPropertiesFontsPrivate = *mut _PpsPropertiesFontsPrivate;

#[repr(C)]
pub struct _PpsPropertiesLicenseClass {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

pub type PpsPropertiesLicenseClass = *mut _PpsPropertiesLicenseClass;

#[repr(C)]
pub struct _PpsPropertiesLicensePrivate {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

pub type PpsPropertiesLicensePrivate = *mut _PpsPropertiesLicensePrivate;
...
impl ::std::fmt::Debug for PpsPropertiesFonts {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsPropertiesFonts @ {self:p}"))
            .finish()
    }
}
...
impl ::std::fmt::Debug for PpsPropertiesLicense {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsPropertiesLicense @ {self:p}"))
            .finish()
    }
}
...
extern "C" {
    ...
    pub fn pps_application_new_window(
        application: *mut PpsApplication,
        display: *mut gdk::GdkDisplay,
        timestamp: u32,
    );
    pub fn pps_application_open_start_view(
        application: *mut PpsApplication,
        display: *mut gdk::GdkDisplay,
    );
    ...
    // PpsPropertiesFonts
    //=========================================================================
    pub fn pps_properties_fonts_get_type() -> GType;
    pub fn pps_properties_fonts_new() -> *mut gtk::GtkWidget;
    pub fn pps_properties_fonts_set_document(
        properties: *mut PpsPropertiesFonts,
        document: *mut papers_document::PpsDocument,
    );

    //=========================================================================
    // PpsPropertiesLicense
    //=========================================================================
    pub fn pps_properties_license_get_type() -> GType;
    pub fn pps_properties_license_new() -> *mut gtk::GtkWidget;
    pub fn pps_properties_license_set_license(
        properties_license: *mut PpsPropertiesLicense,
        license: *mut papers_document::PpsDocumentLicense,
    );
    ...
    pub fn pps_window_get_toolbar(pps_window: *mut PpsWindow) -> *mut adw::AdwHeaderBar;
    ...
    pub fn pps_window_start_page_selector_search(window: *mut PpsWindow);
    ...
    pub fn pps_papers_application_call_reload(
        proxy: *mut PpsPapersApplication,
        arg_args: *mut glib::GVariant,
        arg_timestamp: c_uint,
        cancellable: *mut gio::GCancellable,
        callback: gio::GAsyncReadyCallback,
        user_data: gpointer,
    );
    pub fn pps_papers_application_call_reload_finish(
        proxy: *mut PpsPapersApplication,
        res: *mut gio::GAsyncResult,
        error: *mut *mut glib::GError,
    ) -> gboolean;
    pub fn pps_papers_application_call_reload_sync(
        proxy: *mut PpsPapersApplication,
        arg_args: *mut glib::GVariant,
        arg_timestamp: c_uint,
        cancellable: *mut gio::GCancellable,
    ...
    pub fn pps_papers_application_complete_reload(
        object: *mut PpsPapersApplication,
        invocation: *mut gio::GDBusMethodInvocation,
    );
    ...
    pub fn pps_papers_window_call_sync_view(
        proxy: *mut PpsPapersWindow,
        arg_source_file: *const c_char,
        arg_source_point: *mut glib::GVariant,
        arg_timestamp: c_uint,
        cancellable: *mut gio::GCancellable,
        callback: gio::GAsyncReadyCallback,
        user_data: gpointer,
    );
    pub fn pps_papers_window_call_sync_view_finish(
        proxy: *mut PpsPapersWindow,
        res: *mut gio::GAsyncResult,
        error: *mut *mut glib::GError,
    ) -> gboolean;
    pub fn pps_papers_window_call_sync_view_sync(
        proxy: *mut PpsPapersWindow,
        arg_source_file: *const c_char,
        arg_source_point: *mut glib::GVariant,
        arg_timestamp: c_uint,
    ...
    pub fn pps_papers_window_complete_sync_view(
    ...
    pub fn pps_papers_window_emit_sync_source(
        object: *mut PpsPapersWindow,
        arg_source_file: *const c_char,
        arg_source_point: *mut glib::GVariant,
        arg_timestamp: c_uint,
    ...
    pub fn pps_shell_marshal_VOID__DOUBLE_DOUBLE_POINTER(
