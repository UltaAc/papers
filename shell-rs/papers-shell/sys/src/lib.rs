...
// Records
#[repr(C)]
pub struct _PpsAnnotationPropertiesDialogClass {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

pub type PpsAnnotationPropertiesDialogClass = _PpsAnnotationPropertiesDialogClass;

#[derive(Copy, Clone)]
#[repr(C)]
pub struct PpsFileMonitorClass {
    pub base_class: gobject::GObjectClass,
    pub changed: Option<unsafe extern "C" fn(*mut PpsFileMonitor)>,
}

impl ::std::fmt::Debug for PpsFileMonitorClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsFileMonitorClass @ {self:p}"))
...
pub struct PpsSidebarAnnotationsClass {
    pub base_class: gtk::GtkBoxClass,
    pub annot_activated:
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct PpsSidebarClass {
    pub parent_class: adw::AdwBinClass,
}

impl ::std::fmt::Debug for PpsSidebarClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsSidebarClass @ {self:p}"))
            .field("parent_class", &self.parent_class)
            .finish()
    }
}
...
impl ::std::fmt::Debug for PpsAnnotationPropertiesDialog {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsAnnotationPropertiesDialog @ {self:p}"))
            .finish()
    }
}
...
impl ::std::fmt::Debug for PpsFileMonitor {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsFileMonitor @ {self:p}"))
...
impl ::std::fmt::Debug for PpsSidebar {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsSidebar @ {self:p}"))
            .field("base_instance", &self.base_instance)
            .finish()
    }
}
...
extern "C" {
    ...
    //=========================================================================
    pub fn pps_annotation_properties_dialog_get_type() -> GType;
    pub fn pps_annotation_properties_dialog_new(
        annot_type: papers_document::PpsAnnotationType,
    ) -> *mut gtk::GtkWidget;
    pub fn pps_annotation_properties_dialog_new_with_annotation(
        annot: *mut papers_document::PpsAnnotation,
    ) -> *mut gtk::GtkWidget;
    pub fn pps_annotation_properties_dialog_get_author(
        dialog: *mut PpsAnnotationPropertiesDialog,
    ) -> *const c_char;
    pub fn pps_annotation_properties_dialog_get_opacity(
        dialog: *mut PpsAnnotationPropertiesDialog,
    ) -> c_double;
    pub fn pps_annotation_properties_dialog_get_popup_is_open(
        dialog: *mut PpsAnnotationPropertiesDialog,
    ) -> gboolean;
    pub fn pps_annotation_properties_dialog_get_rgba(
        dialog: *mut PpsAnnotationPropertiesDialog,
        rgba: *mut gdk::GdkRGBA,
    );
    pub fn pps_annotation_properties_dialog_get_text_icon(
        dialog: *mut PpsAnnotationPropertiesDialog,
    ) -> papers_document::PpsAnnotationTextIcon;
    pub fn pps_annotation_properties_dialog_get_text_markup_type(
        dialog: *mut PpsAnnotationPropertiesDialog,
    ) -> papers_document::PpsAnnotationTextMarkupType;

    //=========================================================================
    // PpsFileMonitor
    //=========================================================================
    pub fn pps_file_monitor_get_type() -> GType;
    pub fn pps_file_monitor_new(uri: *const c_char) -> *mut PpsFileMonitor;
    ...
    pub fn pps_message_area_get_info_bar(area: *mut PpsMessageArea) -> *mut gtk::GtkWidget;
    ...
    // PpsSidebar
    //=========================================================================
    pub fn pps_sidebar_get_type() -> GType;
    pub fn pps_sidebar_new() -> *mut gtk::GtkWidget;
    pub fn pps_sidebar_get_current_page(pps_sidebar: *mut PpsSidebar) -> *mut gtk::GtkWidget;
    pub fn pps_sidebar_get_visible_child_name(pps_sidebar: *mut PpsSidebar) -> *const c_char;
    pub fn pps_sidebar_set_model(
        pps_sidebar: *mut PpsSidebar,
        model: *mut papers_view::PpsDocumentModel,
    );
    pub fn pps_sidebar_set_visible_child_name(pps_sidebar: *mut PpsSidebar, name: *const c_char);
    ...
    pub fn pps_sidebar_annotations_annot_changed(
        sidebar_annots: *mut PpsSidebarAnnotations,
        annot: *mut papers_document::PpsAnnotation,
    );
    ...
    pub fn pps_spinner_map_cb(spinner: *mut gtk::GtkSpinner);
    pub fn pps_spinner_unmap_cb(spinner: *mut gtk::GtkSpinner);
