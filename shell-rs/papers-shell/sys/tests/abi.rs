...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    (
        "PpsApplicationClass",
        Layout {
            size: size_of::<PpsApplicationClass>(),
            alignment: align_of::<PpsApplicationClass>(),
        },
    ),
    (
        "PpsObjectIface",
    ...
    (
        "PpsPapersWindowIface",
        Layout {
            size: size_of::<PpsPapersWindowIface>(),
            alignment: align_of::<PpsPapersWindowIface>(),
        },
    ),
    (
        "PpsPapersWindowProxy",
        Layout {
            size: size_of::<PpsPapersWindowProxy>(),
            alignment: align_of::<PpsPapersWindowProxy>(),
        },
    ),
    (
        "PpsPapersWindowProxyClass",
        Layout {
            size: size_of::<PpsPapersWindowProxyClass>(),
            alignment: align_of::<PpsPapersWindowProxyClass>(),
        },
    ),
    (
        "PpsPapersWindowSkeleton",
        Layout {
            size: size_of::<PpsPapersWindowSkeleton>(),
            alignment: align_of::<PpsPapersWindowSkeleton>(),
        },
    ),
    (
        "PpsPapersWindowSkeletonClass",
        Layout {
            size: size_of::<PpsPapersWindowSkeletonClass>(),
            alignment: align_of::<PpsPapersWindowSkeletonClass>(),
        },
    ),
    (
        "PpsPrintPageSet",
        Layout {
            size: size_of::<PpsPrintPageSet>(),
            alignment: align_of::<PpsPrintPageSet>(),
        },
    ),
    (
        "PpsPrintRange",
        Layout {
            size: size_of::<PpsPrintRange>(),
            alignment: align_of::<PpsPrintRange>(),
        },
    ),
    (
        "PpsPropertiesFonts",
        Layout {
            size: size_of::<PpsPropertiesFonts>(),
            alignment: align_of::<PpsPropertiesFonts>(),
        },
    ),
    (
        "PpsPropertiesFontsClass",
        Layout {
            size: size_of::<PpsPropertiesFontsClass>(),
            alignment: align_of::<PpsPropertiesFontsClass>(),
        },
    ),
    (
        "PpsSidebarPageInterface",
        Layout {
            size: size_of::<PpsSidebarPageInterface>(),
            alignment: align_of::<PpsSidebarPageInterface>(),
        },
    ),
    (
        "PpsWindow",
...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ("(gint) PPS_PRINT_PAGE_SET_ALL", "0"),
    ("(gint) PPS_PRINT_PAGE_SET_EVEN", "1"),
    ("(gint) PPS_PRINT_PAGE_SET_ODD", "2"),
