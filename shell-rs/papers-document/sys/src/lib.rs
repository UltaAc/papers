...
// Constants
pub const PPS_MAJOR_VERSION: c_int = 46;
...
pub struct PpsDocumentAnnotationsInterface {
    ...
    pub get_annotations: Option<unsafe extern "C" fn(*mut PpsDocumentAnnotations, *mut PpsPage) -> *mut PpsMappingList>,
    pub document_is_modified: Option<unsafe extern "C" fn(*mut PpsDocumentAnnotations) -> gboolean>,
    pub add_annotation: Option<unsafe extern "C" fn(*mut PpsDocumentAnnotations, *mut PpsAnnotation, *mut PpsRectangle)>,
    pub save_annotation: Option<unsafe extern "C" fn(*mut PpsDocumentAnnotations, *mut PpsAnnotation, PpsAnnotationsSaveMask)>,
    pub remove_annotation: Option<unsafe extern "C" fn(*mut PpsDocumentAnnotations, *mut PpsAnnotation)>,
    pub over_markup: Option<unsafe extern "C" fn(*mut PpsDocumentAnnotations, *mut PpsAnnotation, c_double, c_double) -> PpsAnnotationsOverMarkup>,
}
...
pub struct PpsDocumentAttachmentsInterface {
    ...
    pub get_attachments: Option<unsafe extern "C" fn(*mut PpsDocumentAttachments) -> *mut glib::GList>,
}
...
pub struct PpsDocumentClass {
    pub base_class: gobject::GObjectClass,
    pub load: Option<unsafe extern "C" fn(*mut PpsDocument, *const c_char, *mut *mut glib::GError) -> gboolean>,
    pub save: Option<unsafe extern "C" fn(*mut PpsDocument, *const c_char, *mut *mut glib::GError) -> gboolean>,
    ...
    pub get_page_size: Option<unsafe extern "C" fn(*mut PpsDocument, *mut PpsPage, *mut c_double, *mut c_double)>,
    pub get_page_label: Option<unsafe extern "C" fn(*mut PpsDocument, *mut PpsPage) -> *mut c_char>,
    pub render: Option<unsafe extern "C" fn(*mut PpsDocument, *mut PpsRenderContext) -> *mut cairo::cairo_surface_t>,
    pub get_thumbnail: Option<unsafe extern "C" fn(*mut PpsDocument, *mut PpsRenderContext) -> *mut gdk_pixbuf::GdkPixbuf>,
    pub get_info: Option<unsafe extern "C" fn(*mut PpsDocument) -> *mut PpsDocumentInfo>,
    pub get_backend_info: Option<unsafe extern "C" fn(*mut PpsDocument, *mut PpsDocumentBackendInfo) -> gboolean>,
    pub load_stream: Option<unsafe extern "C" fn(*mut PpsDocument, *mut gio::GInputStream, PpsDocumentLoadFlags, *mut gio::GCancellable, *mut *mut glib::GError) -> gboolean>,
    pub load_gfile: Option<unsafe extern "C" fn(*mut PpsDocument, *mut gio::GFile, PpsDocumentLoadFlags, *mut gio::GCancellable, *mut *mut glib::GError) -> gboolean>,
    pub get_thumbnail_surface: Option<unsafe extern "C" fn(*mut PpsDocument, *mut PpsRenderContext) -> *mut cairo::cairo_surface_t>,
    pub load_fd: Option<unsafe extern "C" fn(*mut PpsDocument, c_int, PpsDocumentLoadFlags, *mut gio::GCancellable, *mut *mut glib::GError) -> gboolean>,
}
...
pub struct PpsDocumentFindInterface {
    ...
    pub find_text: Option<unsafe extern "C" fn(*mut PpsDocumentFind, *mut PpsPage, *const c_char, PpsFindOptions) -> *mut glib::GList>,
}
...
pub struct PpsDocumentFormsInterface {
    pub base_iface: gobject::GTypeInterface,
    pub get_form_fields: Option<unsafe extern "C" fn(*mut PpsDocumentForms, *mut PpsPage) -> *mut PpsMappingList>,
    pub document_is_modified: Option<unsafe extern "C" fn(*mut PpsDocumentForms) -> gboolean>,
    pub form_field_text_get_text: Option<unsafe extern "C" fn(*mut PpsDocumentForms, *mut PpsFormField) -> *mut c_char>,
    pub form_field_text_set_text: Option<unsafe extern "C" fn(*mut PpsDocumentForms, *mut PpsFormField, *const c_char)>,
    pub form_field_button_get_state: Option<unsafe extern "C" fn(*mut PpsDocumentForms, *mut PpsFormField) -> gboolean>,
    pub form_field_button_set_state: Option<unsafe extern "C" fn(*mut PpsDocumentForms, *mut PpsFormField, gboolean)>,
    pub form_field_choice_get_item: Option<unsafe extern "C" fn(*mut PpsDocumentForms, *mut PpsFormField, c_int) -> *mut c_char>,
    pub form_field_choice_get_n_items: Option<unsafe extern "C" fn(*mut PpsDocumentForms, *mut PpsFormField) -> c_int>,
    pub form_field_choice_is_item_selected: Option<unsafe extern "C" fn(*mut PpsDocumentForms, *mut PpsFormField, c_int) -> gboolean>,
    pub form_field_choice_select_item: Option<unsafe extern "C" fn(*mut PpsDocumentForms, *mut PpsFormField, c_int)>,
    pub form_field_choice_toggle_item: Option<unsafe extern "C" fn(*mut PpsDocumentForms, *mut PpsFormField, c_int)>,
    pub form_field_choice_unselect_all: Option<unsafe extern "C" fn(*mut PpsDocumentForms, *mut PpsFormField)>,
    pub form_field_choice_set_text: Option<unsafe extern "C" fn(*mut PpsDocumentForms, *mut PpsFormField, *const c_char)>,
    pub form_field_choice_get_text: Option<unsafe extern "C" fn(*mut PpsDocumentForms, *mut PpsFormField) -> *mut c_char>,
...
impl ::std::fmt::Debug for PpsDocumentFormsInterface {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsDocumentFormsInterface @ {self:p}"))
         ...
         .field("form_field_button_get_state", &self.form_field_button_get_state)
         .field("form_field_button_set_state", &self.form_field_button_set_state)
         .field("form_field_choice_get_item", &self.form_field_choice_get_item)
         .field("form_field_choice_get_n_items", &self.form_field_choice_get_n_items)
         .field("form_field_choice_is_item_selected", &self.form_field_choice_is_item_selected)
         .field("form_field_choice_select_item", &self.form_field_choice_select_item)
         .field("form_field_choice_toggle_item", &self.form_field_choice_toggle_item)
         .field("form_field_choice_unselect_all", &self.form_field_choice_unselect_all)
         .field("form_field_choice_set_text", &self.form_field_choice_set_text)
         .field("form_field_choice_get_text", &self.form_field_choice_get_text)
...
pub struct PpsDocumentImagesInterface {
    pub base_iface: gobject::GTypeInterface,
    pub get_image_mapping: Option<unsafe extern "C" fn(*mut PpsDocumentImages, *mut PpsPage) -> *mut PpsMappingList>,
    pub get_image: Option<unsafe extern "C" fn(*mut PpsDocumentImages, *mut PpsImage) -> *mut gdk_pixbuf::GdkPixbuf>,
}
...
pub struct PpsDocumentLayersInterface {
    ...
    pub layer_is_visible: Option<unsafe extern "C" fn(*mut PpsDocumentLayers, *mut PpsLayer) -> gboolean>,
}
...
pub struct PpsDocumentLinksInterface {
    ...
    pub get_links_model: Option<unsafe extern "C" fn(*mut PpsDocumentLinks) -> *mut gio::GListModel>,
    pub get_links: Option<unsafe extern "C" fn(*mut PpsDocumentLinks, *mut PpsPage) -> *mut PpsMappingList>,
    pub find_link_dest: Option<unsafe extern "C" fn(*mut PpsDocumentLinks, *const c_char) -> *mut PpsLinkDest>,
...
pub struct PpsDocumentMediaInterface {
    pub base_iface: gobject::GTypeInterface,
    pub get_media_mapping: Option<unsafe extern "C" fn(*mut PpsDocumentMedia, *mut PpsPage) -> *mut PpsMappingList>,
}
...
pub struct PpsDocumentPrintInterface {
    pub base_iface: gobject::GTypeInterface,
    pub print_page: Option<unsafe extern "C" fn(*mut PpsDocumentPrint, *mut PpsPage, *mut cairo::cairo_t)>,
}
...
pub struct PpsDocumentTextInterface {
    pub base_iface: gobject::GTypeInterface,
    pub get_text_mapping: Option<unsafe extern "C" fn(*mut PpsDocumentText, *mut PpsPage) -> *mut cairo::cairo_region_t>,
    pub get_text: Option<unsafe extern "C" fn(*mut PpsDocumentText, *mut PpsPage) -> *mut c_char>,
    pub get_text_layout: Option<unsafe extern "C" fn(*mut PpsDocumentText, *mut PpsPage, *mut *mut PpsRectangle, *mut c_uint) -> gboolean>,
    pub get_text_attrs: Option<unsafe extern "C" fn(*mut PpsDocumentText, *mut PpsPage) -> *mut pango::PangoAttrList>,
}
...
pub struct PpsDocumentTransitionInterface {
    pub base_iface: gobject::GTypeInterface,
    pub get_page_duration: Option<unsafe extern "C" fn(*mut PpsDocumentTransition, c_int) -> c_double>,
    pub get_effect: Option<unsafe extern "C" fn(*mut PpsDocumentTransition, c_int) -> *mut PpsTransitionEffect>,
}
...
pub struct PpsFileExporterInterface {
    ...
    pub get_capabilities: Option<unsafe extern "C" fn(*mut PpsFileExporter) -> PpsFileExporterCapabilities>,
}
...
pub struct PpsSelectionInterface {
    pub base_iface: gobject::GTypeInterface,
    pub render_selection: Option<unsafe extern "C" fn(*mut PpsSelection, *mut PpsRenderContext, *mut *mut cairo::cairo_surface_t, *mut PpsRectangle, *mut PpsRectangle, PpsSelectionStyle, *mut gdk::GdkRGBA, *mut gdk::GdkRGBA)>,
    pub get_selected_text: Option<unsafe extern "C" fn(*mut PpsSelection, *mut PpsPage, PpsSelectionStyle, *mut PpsRectangle) -> *mut c_char>,
    pub get_selection_region: Option<unsafe extern "C" fn(*mut PpsSelection, *mut PpsRenderContext, PpsSelectionStyle, *mut PpsRectangle) -> *mut cairo::cairo_region_t>,
}
...
impl ::std::fmt::Debug for PpsLink {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsLink @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for PpsLinkDest {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsLinkDest @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for PpsAnnotationMarkup {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "PpsAnnotationMarkup @ {self:p}")
    }
}
...
extern "C" {
    ...
    pub fn pps_document_info_copy(info: *mut PpsDocumentInfo) -> *mut PpsDocumentInfo;
    pub fn pps_document_info_free(info: *mut PpsDocumentInfo);
    pub fn pps_document_info_get_created_datetime(info: *const PpsDocumentInfo) -> *mut glib::GDateTime;
    pub fn pps_document_info_get_modified_datetime(info: *const PpsDocumentInfo) -> *mut glib::GDateTime;
    pub fn pps_document_info_regular_paper_size(info: *const PpsDocumentInfo) -> *mut c_char;
    pub fn pps_document_info_set_from_xmp(info: *mut PpsDocumentInfo, xmp: *const c_char, size: ssize_t) -> gboolean;
    pub fn pps_document_info_take_created_datetime(info: *mut PpsDocumentInfo, datetime: *mut glib::GDateTime);
    pub fn pps_document_info_take_modified_datetime(info: *mut PpsDocumentInfo, datetime: *mut glib::GDateTime);
    ...
    pub fn pps_document_license_get_web_statement(license: *mut PpsDocumentLicense) -> *const c_char;
    ...
    pub fn pps_mapping_list_new(page: c_uint, list: *mut glib::GList, data_destroy_func: glib::GDestroyNotify) -> *mut PpsMappingList;
    pub fn pps_mapping_list_find(mapping_list: *mut PpsMappingList, data: gconstpointer) -> *mut PpsMapping;
    pub fn pps_mapping_list_find_custom(mapping_list: *mut PpsMappingList, data: gconstpointer, func: glib::GCompareFunc) -> *mut PpsMapping;
    pub fn pps_mapping_list_get(mapping_list: *mut PpsMappingList, x: c_double, y: c_double) -> *mut PpsMapping;
    pub fn pps_mapping_list_get_data(mapping_list: *mut PpsMappingList, x: c_double, y: c_double) -> gpointer;
    ...
    pub fn pps_annotation_set_area(annot: *mut PpsAnnotation, area: *const PpsRectangle) -> gboolean;
    pub fn pps_annotation_set_contents(annot: *mut PpsAnnotation, contents: *const c_char) -> gboolean;
    pub fn pps_annotation_set_modified(annot: *mut PpsAnnotation, modified: *const c_char) -> gboolean;
    pub fn pps_annotation_set_modified_from_time_t(annot: *mut PpsAnnotation, utime: time_t) -> gboolean;
    pub fn pps_annotation_set_name(annot: *mut PpsAnnotation, name: *const c_char) -> gboolean;
    pub fn pps_annotation_set_rgba(annot: *mut PpsAnnotation, rgba: *const gdk::GdkRGBA) -> gboolean;

    //=========================================================================
    // PpsAnnotationAttachment
    //=========================================================================
    pub fn pps_annotation_attachment_get_type() -> GType;
    pub fn pps_annotation_attachment_new(page: *mut PpsPage, attachment: *mut PpsAttachment) -> *mut PpsAnnotation;
    pub fn pps_annotation_attachment_get_attachment(annot: *mut PpsAnnotationAttachment) -> *mut PpsAttachment;
    pub fn pps_annotation_attachment_set_attachment(annot: *mut PpsAnnotationAttachment, attachment: *mut PpsAttachment) -> gboolean;
    ...
    pub fn pps_annotation_text_set_icon(text: *mut PpsAnnotationText, icon: PpsAnnotationTextIcon) -> gboolean;
    pub fn pps_annotation_text_set_is_open(text: *mut PpsAnnotationText, is_open: gboolean) -> gboolean;
    ...
    pub fn pps_annotation_text_markup_get_markup_type(annot: *mut PpsAnnotationTextMarkup) -> PpsAnnotationTextMarkupType;
    pub fn pps_annotation_text_markup_set_markup_type(annot: *mut PpsAnnotationTextMarkup, markup_type: PpsAnnotationTextMarkupType) -> gboolean;

    //=========================================================================
    // PpsAttachment
    //=========================================================================
    pub fn pps_attachment_get_type() -> GType;
    pub fn pps_attachment_new(name: *const c_char, description: *const c_char, mtime: *mut glib::GDateTime, ctime: *mut glib::GDateTime, size: size_t, data: gpointer) -> *mut PpsAttachment;
    pub fn pps_attachment_error_quark() -> glib::GQuark;
    pub fn pps_attachment_get_creation_datetime(attachment: *mut PpsAttachment) -> *mut glib::GDateTime;
    ...
    pub fn pps_attachment_get_modification_datetime(attachment: *mut PpsAttachment) -> *mut glib::GDateTime;
    pub fn pps_attachment_get_name(attachment: *mut PpsAttachment) -> *const c_char;
    pub fn pps_attachment_open(attachment: *mut PpsAttachment, context: *mut gio::GAppLaunchContext, error: *mut *mut glib::GError) -> gboolean;
    pub fn pps_attachment_save(attachment: *mut PpsAttachment, file: *mut gio::GFile, error: *mut *mut glib::GError) -> gboolean;

    //=========================================================================
    // PpsDocument
    //=========================================================================
    pub fn pps_document_get_type() -> GType;
    pub fn pps_document_doc_mutex_lock();
    pub fn pps_document_doc_mutex_trylock() -> gboolean;
    pub fn pps_document_doc_mutex_unlock();
    pub fn pps_document_factory_add_filters(dialog: *mut gtk::GtkFileDialog, document: *mut PpsDocument);
    pub fn pps_document_factory_get_document(uri: *const c_char, error: *mut *mut glib::GError) -> *mut PpsDocument;
    #[cfg(feature = "v42")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v42")))]
    pub fn pps_document_factory_get_document_for_fd(fd: c_int, mime_type: *const c_char, flags: PpsDocumentLoadFlags, cancellable: *mut gio::GCancellable, error: *mut *mut glib::GError) -> *mut PpsDocument;
    pub fn pps_document_factory_get_document_full(uri: *const c_char, flags: PpsDocumentLoadFlags, error: *mut *mut glib::GError) -> *mut PpsDocument;
    pub fn pps_document_fc_mutex_lock();
    pub fn pps_document_fc_mutex_trylock() -> gboolean;
    pub fn pps_document_fc_mutex_unlock();
    pub fn pps_document_misc_format_datetime(dt: *mut glib::GDateTime) -> *mut c_char;
    pub fn pps_document_misc_get_pointer_position(widget: *mut gtk::GtkWidget, x: *mut c_int, y: *mut c_int);
    pub fn pps_document_misc_get_widget_dpi(widget: *mut gtk::GtkWidget) -> c_double;
    pub fn pps_document_misc_pixbuf_from_surface(surface: *mut cairo::cairo_surface_t) -> *mut gdk_pixbuf::GdkPixbuf;
    pub fn pps_document_misc_surface_from_pixbuf(pixbuf: *mut gdk_pixbuf::GdkPixbuf) -> *mut cairo::cairo_surface_t;
    pub fn pps_document_misc_surface_rotate_and_scale(surface: *mut cairo::cairo_surface_t, dest_width: c_int, dest_height: c_int, dest_rotation: c_int) -> *mut cairo::cairo_surface_t;
    pub fn pps_document_misc_texture_from_surface(surface: *mut cairo::cairo_surface_t) -> *mut gdk::GdkTexture;
    pub fn pps_document_check_dimensions(document: *mut PpsDocument) -> gboolean;
    pub fn pps_document_find_page_by_label(document: *mut PpsDocument, page_label: *const c_char, page_index: *mut c_int) -> gboolean;
    pub fn pps_document_get_backend_info(document: *mut PpsDocument, info: *mut PpsDocumentBackendInfo) -> gboolean;
    ...
    pub fn pps_document_get_max_page_size(document: *mut PpsDocument, width: *mut c_double, height: *mut c_double);
    pub fn pps_document_get_min_page_size(document: *mut PpsDocument, width: *mut c_double, height: *mut c_double);
    ...
    pub fn pps_document_get_page_label(document: *mut PpsDocument, page_index: c_int) -> *mut c_char;
    pub fn pps_document_get_page_size(document: *mut PpsDocument, page_index: c_int, width: *mut c_double, height: *mut c_double);
    pub fn pps_document_get_size(document: *mut PpsDocument) -> u64;
    pub fn pps_document_get_thumbnail(document: *mut PpsDocument, rc: *mut PpsRenderContext) -> *mut gdk_pixbuf::GdkPixbuf;
    pub fn pps_document_get_thumbnail_surface(document: *mut PpsDocument, rc: *mut PpsRenderContext) -> *mut cairo::cairo_surface_t;
    ...
    pub fn pps_document_load(document: *mut PpsDocument, uri: *const c_char, error: *mut *mut glib::GError) -> gboolean;
    #[cfg(feature = "v42")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v42")))]
    pub fn pps_document_load_fd(document: *mut PpsDocument, fd: c_int, flags: PpsDocumentLoadFlags, cancellable: *mut gio::GCancellable, error: *mut *mut glib::GError) -> gboolean;
    pub fn pps_document_load_full(document: *mut PpsDocument, uri: *const c_char, flags: PpsDocumentLoadFlags, error: *mut *mut glib::GError) -> gboolean;
    pub fn pps_document_render(document: *mut PpsDocument, rc: *mut PpsRenderContext) -> *mut cairo::cairo_surface_t;
    pub fn pps_document_save(document: *mut PpsDocument, uri: *const c_char, error: *mut *mut glib::GError) -> gboolean;
    ...
    pub fn pps_form_field_button_new(id: c_int, type_: PpsFormFieldButtonType) -> *mut PpsFormField;

    //=========================================================================
    // PpsFormFieldChoice
    //=========================================================================
    pub fn pps_form_field_choice_get_type() -> GType;
    pub fn pps_form_field_choice_new(id: c_int, type_: PpsFormFieldChoiceType) -> *mut PpsFormField;
    ...
    pub fn pps_image_save_tmp(image: *mut PpsImage, pixbuf: *mut gdk_pixbuf::GdkPixbuf) -> *const c_char;
    ...
    pub fn pps_link_action_new_launch(filename: *const c_char, params: *const c_char) -> *mut PpsLinkAction;
    pub fn pps_link_action_new_layers_state(show_list: *mut glib::GList, hide_list: *mut glib::GList, toggle_list: *mut glib::GList) -> *mut PpsLinkAction;
    pub fn pps_link_action_new_named(name: *const c_char) -> *mut PpsLinkAction;
    pub fn pps_link_action_new_remote(dest: *mut PpsLinkDest, filename: *const c_char) -> *mut PpsLinkAction;
    pub fn pps_link_action_new_reset_form(fields: *mut glib::GList, exclude_fields: gboolean) -> *mut PpsLinkAction;
    ...
    pub fn pps_link_dest_new_fith(page: c_int, top: c_double, change_top: gboolean) -> *mut PpsLinkDest;
    pub fn pps_link_dest_new_fitr(page: c_int, left: c_double, bottom: c_double, right: c_double, top: c_double) -> *mut PpsLinkDest;
    pub fn pps_link_dest_new_fitv(page: c_int, left: c_double, change_left: gboolean) -> *mut PpsLinkDest;
    ...
    pub fn pps_link_dest_new_xyz(page: c_int, left: c_double, top: c_double, zoom: c_double, change_left: gboolean, change_top: gboolean, change_zoom: gboolean) -> *mut PpsLinkDest;
    ...
    pub fn pps_outlines_set_children(pps_outlines: *mut PpsOutlines, children: *mut gio::GListModel);
    ...
    pub fn pps_render_context_new(page: *mut PpsPage, rotation: c_int, scale: c_double) -> *mut PpsRenderContext;
    pub fn pps_render_context_compute_scaled_size(rc: *mut PpsRenderContext, width_points: c_double, height_points: c_double, scaled_width: *mut c_int, scaled_height: *mut c_int);
    pub fn pps_render_context_compute_scales(rc: *mut PpsRenderContext, width_points: c_double, height_points: c_double, scale_x: *mut c_double, scale_y: *mut c_double);
    pub fn pps_render_context_compute_transformed_size(rc: *mut PpsRenderContext, width_points: c_double, height_points: c_double, transformed_width: *mut c_int, transformed_height: *mut c_int);
    ...
    pub fn pps_render_context_set_target_size(rc: *mut PpsRenderContext, target_width: c_int, target_height: c_int);

    //=========================================================================
    // PpsTransitionEffect
    //=========================================================================
    pub fn pps_transition_effect_get_type() -> GType;
    pub fn pps_transition_effect_new(type_: PpsTransitionEffectType, first_property_name: *const c_char, ...) -> *mut PpsTransitionEffect;
    ...
    pub fn pps_annotation_markup_get_rectangle(markup: *mut PpsAnnotationMarkup, pps_rect: *mut PpsRectangle);
    pub fn pps_annotation_markup_has_popup(markup: *mut PpsAnnotationMarkup) -> gboolean;
    pub fn pps_annotation_markup_set_has_popup(markup: *mut PpsAnnotationMarkup, has_popup: gboolean) -> gboolean;
    pub fn pps_annotation_markup_set_label(markup: *mut PpsAnnotationMarkup, label: *const c_char) -> gboolean;
    pub fn pps_annotation_markup_set_opacity(markup: *mut PpsAnnotationMarkup, opacity: c_double) -> gboolean;
    pub fn pps_annotation_markup_set_popup_is_open(markup: *mut PpsAnnotationMarkup, is_open: gboolean) -> gboolean;
    pub fn pps_annotation_markup_set_rectangle(markup: *mut PpsAnnotationMarkup, pps_rect: *const PpsRectangle) -> gboolean;

    //=========================================================================
    // PpsDocumentAnnotations
    //=========================================================================
    pub fn pps_document_annotations_get_type() -> GType;
    pub fn pps_document_annotations_add_annotation(document_annots: *mut PpsDocumentAnnotations, annot: *mut PpsAnnotation, rect: *mut PpsRectangle);
    pub fn pps_document_annotations_can_add_annotation(document_annots: *mut PpsDocumentAnnotations) -> gboolean;
    pub fn pps_document_annotations_can_remove_annotation(document_annots: *mut PpsDocumentAnnotations) -> gboolean;
    pub fn pps_document_annotations_document_is_modified(document_annots: *mut PpsDocumentAnnotations) -> gboolean;
    pub fn pps_document_annotations_get_annotations(document_annots: *mut PpsDocumentAnnotations, page: *mut PpsPage) -> *mut PpsMappingList;
    pub fn pps_document_annotations_over_markup(document_annots: *mut PpsDocumentAnnotations, annot: *mut PpsAnnotation, x: c_double, y: c_double) -> PpsAnnotationsOverMarkup;
    pub fn pps_document_annotations_remove_annotation(document_annots: *mut PpsDocumentAnnotations, annot: *mut PpsAnnotation);
    pub fn pps_document_annotations_save_annotation(document_annots: *mut PpsDocumentAnnotations, annot: *mut PpsAnnotation, mask: PpsAnnotationsSaveMask);

    //=========================================================================
    // PpsDocumentAttachments
    //=========================================================================
    pub fn pps_document_attachments_get_type() -> GType;
    pub fn pps_document_attachments_get_attachments(document_attachments: *mut PpsDocumentAttachments) -> *mut glib::GList;
    pub fn pps_document_attachments_has_attachments(document_attachments: *mut PpsDocumentAttachments) -> gboolean;

    //=========================================================================
    // PpsDocumentFind
    //=========================================================================
    pub fn pps_document_find_get_type() -> GType;
    pub fn pps_document_find_find_text(document_find: *mut PpsDocumentFind, page: *mut PpsPage, text: *const c_char, options: PpsFindOptions) -> *mut glib::GList;
    pub fn pps_document_find_get_supported_options(document_find: *mut PpsDocumentFind) -> PpsFindOptions;

    //=========================================================================
    // PpsDocumentFonts
    //=========================================================================
    pub fn pps_document_fonts_get_type() -> GType;
    pub fn pps_document_fonts_get_fonts_summary(document_fonts: *mut PpsDocumentFonts) -> *const c_char;
    pub fn pps_document_fonts_get_model(document_fonts: *mut PpsDocumentFonts) -> *mut gio::GListModel;
    ...
    pub fn pps_document_forms_document_is_modified(document_forms: *mut PpsDocumentForms) -> gboolean;
    pub fn pps_document_forms_form_field_button_get_state(document_forms: *mut PpsDocumentForms, field: *mut PpsFormField) -> gboolean;
    pub fn pps_document_forms_form_field_button_set_state(document_forms: *mut PpsDocumentForms, field: *mut PpsFormField, state: gboolean);
    pub fn pps_document_forms_form_field_choice_get_item(document_forms: *mut PpsDocumentForms, field: *mut PpsFormField, index: c_int) -> *mut c_char;
    pub fn pps_document_forms_form_field_choice_get_n_items(document_forms: *mut PpsDocumentForms, field: *mut PpsFormField) -> c_int;
    pub fn pps_document_forms_form_field_choice_get_text(document_forms: *mut PpsDocumentForms, field: *mut PpsFormField) -> *mut c_char;
    pub fn pps_document_forms_form_field_choice_is_item_selected(document_forms: *mut PpsDocumentForms, field: *mut PpsFormField, index: c_int) -> gboolean;
    pub fn pps_document_forms_form_field_choice_select_item(document_forms: *mut PpsDocumentForms, field: *mut PpsFormField, index: c_int);
    pub fn pps_document_forms_form_field_choice_set_text(document_forms: *mut PpsDocumentForms, field: *mut PpsFormField, text: *const c_char);
    pub fn pps_document_forms_form_field_choice_toggle_item(document_forms: *mut PpsDocumentForms, field: *mut PpsFormField, index: c_int);
    pub fn pps_document_forms_form_field_choice_unselect_all(document_forms: *mut PpsDocumentForms, field: *mut PpsFormField);
    pub fn pps_document_forms_form_field_text_get_text(document_forms: *mut PpsDocumentForms, field: *mut PpsFormField) -> *mut c_char;
    pub fn pps_document_forms_form_field_text_set_text(document_forms: *mut PpsDocumentForms, field: *mut PpsFormField, text: *const c_char);
    pub fn pps_document_forms_get_form_fields(document_forms: *mut PpsDocumentForms, page: *mut PpsPage) -> *mut PpsMappingList;
    pub fn pps_document_forms_reset_form(document_forms: *mut PpsDocumentForms, action: *mut PpsLinkAction);

    //=========================================================================
    // PpsDocumentImages
    //=========================================================================
    pub fn pps_document_images_get_type() -> GType;
    pub fn pps_document_images_get_image(document_images: *mut PpsDocumentImages, image: *mut PpsImage) -> *mut gdk_pixbuf::GdkPixbuf;
    pub fn pps_document_images_get_image_mapping(document_images: *mut PpsDocumentImages, page: *mut PpsPage) -> *mut PpsMappingList;

    //=========================================================================
    // PpsDocumentLayers
    //=========================================================================
    pub fn pps_document_layers_get_type() -> GType;
    pub fn pps_document_layers_get_layers(document_layers: *mut PpsDocumentLayers) -> *mut gio::GListModel;
    pub fn pps_document_layers_has_layers(document_layers: *mut PpsDocumentLayers) -> gboolean;
    pub fn pps_document_layers_hide_layer(document_layers: *mut PpsDocumentLayers, layer: *mut PpsLayer);
    pub fn pps_document_layers_layer_is_visible(document_layers: *mut PpsDocumentLayers, layer: *mut PpsLayer) -> gboolean;
    pub fn pps_document_layers_show_layer(document_layers: *mut PpsDocumentLayers, layer: *mut PpsLayer);

    //=========================================================================
    // PpsDocumentLinks
    //=========================================================================
    pub fn pps_document_links_get_type() -> GType;
    pub fn pps_document_links_find_link_dest(document_links: *mut PpsDocumentLinks, link_name: *const c_char) -> *mut PpsLinkDest;
    pub fn pps_document_links_find_link_page(document_links: *mut PpsDocumentLinks, link_name: *const c_char) -> c_int;
    pub fn pps_document_links_get_dest_page(document_links: *mut PpsDocumentLinks, dest: *mut PpsLinkDest) -> c_int;
    pub fn pps_document_links_get_dest_page_label(document_links: *mut PpsDocumentLinks, dest: *mut PpsLinkDest) -> *mut c_char;
    pub fn pps_document_links_get_link_page(document_links: *mut PpsDocumentLinks, link: *mut PpsLink) -> c_int;
    pub fn pps_document_links_get_link_page_label(document_links: *mut PpsDocumentLinks, link: *mut PpsLink) -> *mut c_char;
    pub fn pps_document_links_get_links(document_links: *mut PpsDocumentLinks, page: *mut PpsPage) -> *mut PpsMappingList;
    pub fn pps_document_links_get_links_model(document_links: *mut PpsDocumentLinks) -> *mut gio::GListModel;
    pub fn pps_document_links_has_document_links(document_links: *mut PpsDocumentLinks) -> gboolean;

    //=========================================================================
    // PpsDocumentMedia
    //=========================================================================
    pub fn pps_document_media_get_type() -> GType;
    pub fn pps_document_media_get_media_mapping(document_media: *mut PpsDocumentMedia, page: *mut PpsPage) -> *mut PpsMappingList;

    //=========================================================================
    // PpsDocumentPrint
    //=========================================================================
    pub fn pps_document_print_get_type() -> GType;
    pub fn pps_document_print_print_page(document_print: *mut PpsDocumentPrint, page: *mut PpsPage, cr: *mut cairo::cairo_t);

    //=========================================================================
    // PpsDocumentSecurity
    //=========================================================================
    pub fn pps_document_security_get_type() -> GType;
    pub fn pps_document_security_has_document_security(document_security: *mut PpsDocumentSecurity) -> gboolean;
    pub fn pps_document_security_set_password(document_security: *mut PpsDocumentSecurity, password: *const c_char);

    //=========================================================================
    // PpsDocumentText
    //=========================================================================
    pub fn pps_document_text_get_type() -> GType;
    pub fn pps_document_text_get_text(document_text: *mut PpsDocumentText, page: *mut PpsPage) -> *mut c_char;
    pub fn pps_document_text_get_text_attrs(document_text: *mut PpsDocumentText, page: *mut PpsPage) -> *mut pango::PangoAttrList;
    pub fn pps_document_text_get_text_layout(document_text: *mut PpsDocumentText, page: *mut PpsPage, areas: *mut *mut PpsRectangle, n_areas: *mut c_uint) -> gboolean;
    pub fn pps_document_text_get_text_mapping(document_text: *mut PpsDocumentText, page: *mut PpsPage) -> *mut cairo::cairo_region_t;

    //=========================================================================
    // PpsDocumentTransition
    //=========================================================================
    pub fn pps_document_transition_get_type() -> GType;
    pub fn pps_document_transition_get_effect(document_trans: *mut PpsDocumentTransition, page: c_int) -> *mut PpsTransitionEffect;
    pub fn pps_document_transition_get_page_duration(document_trans: *mut PpsDocumentTransition, page: c_int) -> c_double;
    ...
    pub fn pps_file_exporter_get_capabilities(exporter: *mut PpsFileExporter) -> PpsFileExporterCapabilities;

    //=========================================================================
    // PpsSelection
    //=========================================================================
    pub fn pps_selection_get_type() -> GType;
    pub fn pps_selection_get_selected_text(selection: *mut PpsSelection, page: *mut PpsPage, style: PpsSelectionStyle, points: *mut PpsRectangle) -> *mut c_char;
    pub fn pps_selection_get_selection_region(selection: *mut PpsSelection, rc: *mut PpsRenderContext, style: PpsSelectionStyle, points: *mut PpsRectangle) -> *mut cairo::cairo_region_t;
    pub fn pps_selection_render_selection(selection: *mut PpsSelection, rc: *mut PpsRenderContext, surface: *mut *mut cairo::cairo_surface_t, points: *mut PpsRectangle, old_points: *mut PpsRectangle, style: PpsSelectionStyle, text: *mut gdk::GdkRGBA, base: *mut gdk::GdkRGBA);

    //=========================================================================
    // Other functions
    //=========================================================================
    pub fn pps_backend_query_type() -> GType;
    pub fn pps_file_compress(uri: *const c_char, type_: PpsCompressionType, error: *mut *mut glib::GError) -> *mut c_char;
    pub fn pps_file_copy_metadata(from: *const c_char, to: *const c_char, error: *mut *mut glib::GError) -> gboolean;
    pub fn pps_file_get_mime_type(uri: *const c_char, fast: gboolean, error: *mut *mut glib::GError) -> *mut c_char;
    ...
    pub fn pps_file_uncompress(uri: *const c_char, type_: PpsCompressionType, error: *mut *mut glib::GError) -> *mut c_char;
    pub fn pps_get_locale_dir() -> *const c_char;
    pub fn pps_init() -> gboolean;
    pub fn pps_mkdtemp(tmpl: *const c_char, error: *mut *mut glib::GError) -> *mut c_char;
    pub fn pps_mkstemp(tmpl: *const c_char, file_name: *mut *mut c_char, error: *mut *mut glib::GError) -> c_int;
    ...
    pub fn pps_xfer_uri_simple(from: *const c_char, to: *const c_char, error: *mut *mut glib::GError) -> gboolean;
