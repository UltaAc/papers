...
// Records
#[repr(C)]
pub struct _PpsAnnotationAttachmentClass {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

pub type PpsAnnotationAttachmentClass = *mut _PpsAnnotationAttachmentClass;

#[repr(C)]
pub struct _PpsAnnotationClass {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

pub type PpsAnnotationClass = *mut _PpsAnnotationClass;
...
pub type PpsAnnotationMarkupInterface = *mut _PpsAnnotationMarkupInterface;

#[repr(C)]
pub struct _PpsAnnotationTextClass {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

pub type PpsAnnotationTextClass = *mut _PpsAnnotationTextClass;

#[repr(C)]
pub struct _PpsAnnotationTextMarkupClass {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

pub type PpsAnnotationTextMarkupClass = *mut _PpsAnnotationTextMarkupClass;
...
pub struct PpsDocumentAnnotationsInterface {
    ...
    pub add_annotation: Option<
        unsafe extern "C" fn(*mut PpsDocumentAnnotations, *mut PpsAnnotation, *mut PpsRectangle),
    >,
...
pub struct PpsDocumentClass {
    ...
    pub support_synctex: Option<unsafe extern "C" fn(*mut PpsDocument) -> gboolean>,
...
impl ::std::fmt::Debug for PpsDocumentClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsDocumentClass @ {self:p}"))
            ...
            .field("support_synctex", &self.support_synctex)
...
pub struct PpsDocumentFontsInterface {
    pub base_iface: gobject::GTypeInterface,
    pub scan: Option<unsafe extern "C" fn(*mut PpsDocumentFonts, c_int) -> gboolean>,
    pub fill_model: Option<unsafe extern "C" fn(*mut PpsDocumentFonts, *mut gtk::GtkTreeModel)>,
...
impl ::std::fmt::Debug for PpsDocumentFontsInterface {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsDocumentFontsInterface @ {self:p}"))
            ...
            .field("fill_model", &self.fill_model)
...
pub struct PpsDocumentLayersInterface {
    ...
    pub get_layers: Option<unsafe extern "C" fn(*mut PpsDocumentLayers) -> *mut gtk::GtkTreeModel>,
...
pub struct PpsDocumentLinksInterface {
    ...
    pub get_links_model:
        Option<unsafe extern "C" fn(*mut PpsDocumentLinks) -> *mut gtk::GtkTreeModel>,
    pub get_links:
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct PpsSourceLink {
    pub filename: *mut c_char,
    pub line: c_int,
    pub col: c_int,
}

impl ::std::fmt::Debug for PpsSourceLink {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PpsSourceLink @ {self:p}"))
            .field("filename", &self.filename)
...
extern "C" {
    ...
    // PpsSourceLink
    //=========================================================================
    pub fn pps_source_link_get_type() -> GType;
    pub fn pps_source_link_new(
        filename: *const c_char,
        line: c_int,
        col: c_int,
    ) -> *mut PpsSourceLink;
    pub fn pps_source_link_copy(link: *mut PpsSourceLink) -> *mut PpsSourceLink;
    pub fn pps_source_link_free(link: *mut PpsSourceLink);
    ...
    pub fn pps_document_factory_add_filters(
        chooser: *mut gtk::GtkFileChooser,
    ...
    pub fn pps_document_misc_invert_surface(surface: *mut cairo::cairo_surface_t);
    pub fn pps_document_misc_pixbuf_from_surface(
        surface: *mut cairo::cairo_surface_t,
    ) -> *mut gdk_pixbuf::GdkPixbuf;
    pub fn pps_document_misc_render_loading_thumbnail_surface(
        widget: *mut gtk::GtkWidget,
        width: c_int,
        height: c_int,
        inverted_colors: gboolean,
    ) -> *mut cairo::cairo_surface_t;
    pub fn pps_document_misc_render_thumbnail_surface_with_frame(
        widget: *mut gtk::GtkWidget,
        source_surface: *mut cairo::cairo_surface_t,
        width: c_int,
        height: c_int,
    ) -> *mut cairo::cairo_surface_t;
    ...
    pub fn pps_document_has_synctex(document: *mut PpsDocument) -> gboolean;
    ...
    pub fn pps_document_synctex_backward_search(
        document: *mut PpsDocument,
        page_index: c_int,
        x: c_float,
        y: c_float,
    ) -> *mut PpsSourceLink;
    pub fn pps_document_synctex_forward_search(
        document: *mut PpsDocument,
        source_link: *mut PpsSourceLink,
    ) -> *mut PpsMapping;
    ...
    pub fn pps_layer_new(is_parent: gboolean, rb_group: c_int) -> *mut PpsLayer;
    pub fn pps_layer_get_rb_group(layer: *mut PpsLayer) -> c_int;
    pub fn pps_layer_is_parent(layer: *mut PpsLayer) -> gboolean;
    ...
    pub fn pps_document_fonts_fill_model(
        document_fonts: *mut PpsDocumentFonts,
        model: *mut gtk::GtkTreeModel,
    );
    pub fn pps_document_fonts_get_fonts_summary(
        document_fonts: *mut PpsDocumentFonts,
    ) -> *const c_char;
    pub fn pps_document_fonts_scan(
        document_fonts: *mut PpsDocumentFonts,
        n_pages: c_int,
    ) -> gboolean;
