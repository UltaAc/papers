...
// Callbacks
pub type PpsSignaturePasswordCallback = Option<unsafe extern "C" fn(*const c_char) -> *mut c_char>;
...
pub struct PpsDocumentSignaturesInterface {
    pub base_iface: gobject::GTypeInterface,
    pub set_password_callback:
        Option<unsafe extern "C" fn(*mut PpsDocumentSignatures, PpsSignaturePasswordCallback)>,
...
extern "C" {
    ...
    pub fn pps_mapping_copy(pps_mapping: *mut PpsMapping) -> *mut PpsMapping;
    ...
    pub fn pps_signature_new() -> *mut PpsSignature;
