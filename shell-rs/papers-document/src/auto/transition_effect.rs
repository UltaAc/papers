...
pub trait TransitionEffectExt: IsA<TransitionEffect> + sealed::Sealed + 'static {
    ...
    fn connect_alignment_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_alignment_trampoline<P: IsA<TransitionEffect>, F: Fn(&P) + 'static>(this: *mut ffi::PpsTransitionEffect, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_angle_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_angle_trampoline<P: IsA<TransitionEffect>, F: Fn(&P) + 'static>(this: *mut ffi::PpsTransitionEffect, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(TransitionEffect::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_direction_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_direction_trampoline<P: IsA<TransitionEffect>, F: Fn(&P) + 'static>(this: *mut ffi::PpsTransitionEffect, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(TransitionEffect::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_duration_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_duration_trampoline<P: IsA<TransitionEffect>, F: Fn(&P) + 'static>(this: *mut ffi::PpsTransitionEffect, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(TransitionEffect::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_duration_real_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_duration_real_trampoline<P: IsA<TransitionEffect>, F: Fn(&P) + 'static>(this: *mut ffi::PpsTransitionEffect, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(TransitionEffect::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::duration-real\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_duration_real_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "rectangular")]
    fn connect_rectangular_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_rectangular_trampoline<P: IsA<TransitionEffect>, F: Fn(&P) + 'static>(this: *mut ffi::PpsTransitionEffect, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(TransitionEffect::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::rectangular\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_rectangular_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "scale")]
    fn connect_scale_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_scale_trampoline<P: IsA<TransitionEffect>, F: Fn(&P) + 'static>(this: *mut ffi::PpsTransitionEffect, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(TransitionEffect::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_type_trampoline<P: IsA<TransitionEffect>, F: Fn(&P) + 'static>(this: *mut ffi::PpsTransitionEffect, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(TransitionEffect::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
