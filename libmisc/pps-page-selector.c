...
/* Widget we pass back */
static gboolean pps_page_selector_completion_search_is_enabled (PpsPageSelector *proxy);
...
activate_cb (PpsPageSelector *page_selector)
{
	...
	if (!pps_page_selector_completion_search_is_enabled (page_selector)) {
...
static void
disable_completion_search (PpsPageSelector *page_selector)
{
	pps_page_selector_enable_completion_search (page_selector, FALSE);
}
			 ...
			 PpsPageSelector *proxy)
{
	...
	g_object_set (renderer, "text", pps_link_get_title (link), NULL);
...
void
pps_page_selector_update_links_model (PpsPageSelector *proxy, GtkTreeModel *model)
{
	GtkTreeModel *filter_model;
	GtkEntryCompletion *completion;
	GtkCellRenderer *renderer;
...
void
pps_page_selector_clear (PpsPageSelector *proxy)
{
...
void
pps_page_selector_set_temporary_entry_width (PpsPageSelector *proxy, gint width)
{
...
void
pps_page_selector_enable_completion_search (PpsPageSelector *proxy, gboolean enable)
{
...
static gboolean
pps_page_selector_completion_search_is_enabled (PpsPageSelector *proxy)
{
